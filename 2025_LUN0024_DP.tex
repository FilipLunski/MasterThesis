...
\CzechAbstract{ Rozvoj technologie v posledních letech, zejména v oblasti umělé inteligence a neuronových sítí, umožňuje koplešnější analýzy chování osob. Dalo by se tak bezpečnostní kamery využit pro zajištění bezpečnosti osob. V této práci je tak navrženo řešení pro detekci pádu osob v obrazovém toku v reálném čase. Řešení je postaveno na kombinaci dvou neuronových sítí. První detekuje všechny osoby v obraze a jejich klíčové body, druhá tyto body klasifikuje do tříd normální a upadl. V práci je popsán výběr detektoru pózy, návrh architektury klasifikační sítě a implementace výsledného detektoru pádu. Ve výsledné řešení je použit model YOLO11-pose a rekurenetní neuronová síť postavená na architektuře GRU}
