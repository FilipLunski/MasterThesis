...
\EnglishKeywords{python, machine learning, neural networks, convolutional neural networks, pose estimation, behaviour detection, fall detection, }
...
\input{Chapters/103_RNN}
% \part{Detekce osob a jejich pozice}
\input{Chapters/201_Pose}
