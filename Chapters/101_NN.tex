...
Další novější alternativou podobnou ReLU je Mish \cite{mishaf}. Její výhoda je,
že přechod mezi zápornými a kladnými hodnotami je oproti ReLu plynulý. Je to
ale za cenu vyšší výpočetní náročnosti. Formálně je popsána takto:
