...
% Mask R-CNN \cite{mask-r-cnn} je rozšířením Faster R-CNN, které přidává
% nové funkce pro segmentaci objektů, což umožňuje přesnější detekci a lokalizaci
% objektů v obraze. Tento algoritmus využívá architekturu, která kombinuje
% region proposal network s plně konvolučními vrstvami, což zvyšuje efektivitu
% a přesnost detekce.
