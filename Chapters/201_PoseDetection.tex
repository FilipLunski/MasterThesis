...
první fáze detektor objektů). Výhodou tohoto frameworku je jeho kontinuální
...
zajišťuje, že se výstupy algoritmu shodují s vstupy s přesností pixelu.
...
klesá v méně typických pózách či natočeních v obraze. Jelikož ale je naše práce
...
rekurentní neuronovou síť, nemuselo by být nutné používat funkci sledování a
